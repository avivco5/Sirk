...
DEVICE = "tcp:172.20.186.151:5760"
BAUD   = 115200
...
# Hardcoded TCP to WSL SITL connection
# If your WSL IP changes, update it here
...
def _resolve_master_and_baud(cli_master=None, cli_baud=None):
    ...
    # 3) Hardcoded DEVICE/BAUD in this file
    if DEVICE:
        return DEVICE, BAUD or 115200

    # 4) Autodetect fallback
    if sys.platform.startswith("linux"):
...
class MJPEGServer:
    def __init__(self, host="0.0.0.0", port=5000):
        ...
        # Note: Importing Flask lazily in start()
