...
typedef struct {
     ...
     * 120s, UAV Pilot believe calibration failed.
     * @return Execution result.
     */
 ...
 * @return Execution result.
 */
T_UAVReturnCode UAV_Gimbal_Init(void);
/**
 * @brief Deinitialise gimbal module.
 * @return Execution result.
 */
T_UAVReturnCode UAV_Gimbal_DeInit(void);
 ...
 * @return Execution result.
 */
T_UAVReturnCode UAV_Gimbal_RegCommonHandler(const T_UAVGimbalCommonHandler *commonHandler);
