 ...
 */
typedef enum {
    UAV_CAMERA_SHOOT_PHOTO_MODE_SINGLE = 1, /*!< Single photographing mode. */
    UAV_CAMERA_SHOOT_PHOTO_MODE_BURST = 4, /*!< Burst photographing mode. */
    UAV_CAMERA_SHOOT_PHOTO_MODE_INTERVAL = 6, /*!< Interval photographing mode. */
...
typedef enum {
     ...
     * limit of the channel that feedback by interface #UAV_PayloadCamera_GetVideoStreamState.*/
...
typedef struct {
     ...
     * @return Execution result.
     */
    T_UAVReturnCode (*SetDigitalZoomFactor)(uav_f32_t factor);
     ...
     * @return Execution result.
     */
    T_UAVReturnCode (*GetDigitalZoomFactor)(uav_f32_t *factor);
...
typedef struct {
     ...
     * @return Execution result.
     */
    T_UAVReturnCode (*GetOpticalZoomFactor)(uav_f32_t *factor);
 ...
 * @return Execution result.
 */
T_UAVReturnCode UAV_PayloadCamera_Init(void);
 ...
 * SD card operation, camera status interface. Registration of this interface needs to be after UAV_PayloadCamera_Init.
 * @param cameraCommonHandler: pointer to the handler for payload camera common functions.
 * @return Execution result.
 */
T_UAVReturnCode UAV_PayloadCamera_RegCommonHandler(const T_UAVCameraCommonHandler *cameraCommonHandler);
 ...
 * of the interface parameters. Registration of this interface needs to be after UAV_PayloadCamera_Init.
 * @param cameraExposureMeteringHandler: pointer to the handler for payload camera exposure and metering functions.
 * @return Execution result.
 */
T_UAVReturnCode UAV_PayloadCamera_RegExposureMeteringHandler(const T_UAVCameraExposureMeteringHandler
 ...
 * this interface needs to be after UAV_PayloadCamera_Init.
 * @param cameraFocusHandler: pointer to the handler for payload camera focus functions.
 * @return Execution result.
 */
T_UAVReturnCode UAV_PayloadCamera_RegFocusHandler(const T_UAVCameraFocusHandler *cameraFocusHandler);
 ...
 * needs to be after UAV_PayloadCamera_Init.
 * @param cameraDigitalZoomHandler: pointer to the handler for payload camera digital zoom functions.
 * @return Execution result.
 */
T_UAVReturnCode UAV_PayloadCamera_RegDigitalZoomHandler(const T_UAVCameraDigitalZoomHandler *cameraDigitalZoomHandler);
 ...
 * zoom. Registration of this interface needs to be after UAV_PayloadCamera_Init.
 * @param cameraOpticalZoomHandler: pointer to the handler for payload camera optical zoom functions.
 * @return Execution result.
 */
T_UAVReturnCode UAV_PayloadCamera_RegOpticalZoomHandler(const T_UAVCameraOpticalZoomHandler *cameraOpticalZoomHandler);
 ...
 * @return Execution result.
 */
T_UAVReturnCode UAV_PayloadCamera_RegTapZoomHandler(const T_UAVCameraTapZoomHandler *cameraTapZoomHandler);
 ...
 * @return Execution result.
 */
T_UAVReturnCode UAV_PayloadCamera_RegMediaDownloadPlaybackHandler(const T_UAVCameraMediaDownloadPlaybackHandler *cameraMediaHandler);
 ...
 * @return Execution result.
 */
T_UAVReturnCode UAV_PayloadCamera_SetVideoStreamType(E_UAVCameraVideoStreamType videoStreamType);
 ...
 * @return Execution result.
 */
T_UAVReturnCode UAV_PayloadCamera_GetVideoStreamRemoteAddress(char *ipAddr, uint16_t *port);
 ...
 * get state of "videoStream" channel via UAV_PayloadCamera_GetVideoStreamState() function. If actual bandwidth
 ...
 * @return Execution result.
 */
T_UAVReturnCode UAV_PayloadCamera_SendVideoStream(const uint8_t *data, uint16_t len);
 ...
 * @return Execution result.
 */
T_UAVReturnCode UAV_PayloadCamera_GetVideoStreamState(T_UAVDataChannelState *state);
 ...
 * @return Execution result.
 */
T_UAVReturnCode UAV_PayloadCamera_PushAddedMediaFileInfo(const char *filePath, T_UAVCameraMediaFileInfo mediaFileInfo);
 ...
 * @return Execution result.
 */
T_UAVReturnCode UAV_PayloadCamera_GetCameraOpticalZoomSpecOfPayload(E_UAVMountPosition payloadPosition,
 ...
 * @return Execution result.
 */
T_UAVReturnCode UAV_PayloadCamera_GetCameraHybridZoomFocalLengthOfPayload(E_UAVMountPosition payloadPosition,
